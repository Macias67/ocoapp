...
var Custom = function () {
	...
	var handleTrackpadScrollEmulator = function () {
	...
	var handleSocialShare = function () {
	...
	var renderHeroSearchForm = function () {
	...
	var handleMultipleModalHack = function () {
	...
	var handleMapRowListing = function () {
	...
	var handleMobileNavButton = function () {
	...
	var handleDuplicateDesiredElement = function () {
	...
	var handlePreviewMultiFile = function () {
	...
	/**
	 * @TODO Revisar el enlace PHP y objecto checkDate
	 */
	...
	/**
	 * @TODO Revisar el enlace PHP
	 */
	var handleFormEmailValidacion = function () {
	...
	return {
		init: function () {
			...
			handleICheck();
			handleSmoothScroll();
			handleModalAfterClick();
			handleMultipleModalHack();
			handleMapRowListing();
			handleMoreMenu();
			handleMobileNavButton();
			handleDuplicateDesiredElement();
			handlePreviewMultiFile();
			handleNoUISlider();
			handleCalendar();
			handleFormEmailValidacion();
